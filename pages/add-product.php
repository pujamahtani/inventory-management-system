                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <!-- BEGIN FORM-->
<form action="scrips/product/add.php" id="add_product_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select name="supplier_id[]" id="supplier_id" class="form-control" multiple="multiple">
                            <option></option>
                            <?php
							require_once("scrips/product/operations.php");
