									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="row">
													<form action="http://<?php echo BASE_SERVER;?>/erp/pages/scrips/supplier/edit.php" method="POST" id="manage_supplier_form">
														<div class="form-body">
															...
															<div class="form-group clearfix">
																<label class="control-label col-md-3">Supplier Address<span class="required"> * </span></label>
																<div class="col-md-9">
								...
								<div class="modal fade" tabindex="-1" id="deleteModal">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<form action="http://localhost/erp/pages/scrips/supplier/delete.php" method="POST">
...
<![endif]-->
		...
		<script>
				...
				toastr["success"]("Successfully Edited!!", "Supplier Edit")
		</script>
		 <?php
