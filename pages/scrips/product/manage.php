...
$number_filtered_row = mysqli_num_rows($result);//yeh datatbase //maise kitne rows hai wo la raha hai!
...
while($row = mysqli_fetch_assoc($result)){
	...
	if($row['image_extension'] != "")
		...
		src='http://localhost/erp/assets/product/images/" . $image_name . "'>";
	
	else $image_path ='<img class = "img-responsive" src="http://www.placehold.it/75x75/EFEFEF/AAAAAA&AMP;text=no+image" alt=""/>';
